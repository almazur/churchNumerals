...
/* package churchNumerals-0.1.0.0 */
#ifndef VERSION_churchNumerals
#define VERSION_churchNumerals "0.1.0.0"
#endif /* VERSION_churchNumerals */
#ifndef MIN_VERSION_churchNumerals
#define MIN_VERSION_churchNumerals(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_churchNumerals */
...
#define CURRENT_PACKAGE_KEY "churchNumerals-0.1.0.0-4PtX5Szs0dUFrkBbdQoATg"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "churchNumerals-0.1.0.0-4PtX5Szs0dUFrkBbdQoATg"
